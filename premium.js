const perguntasPremium = [
  ...
  {
    texto: "<p>Os resultados de um ensaio clínico randomizado na Indonésia apontaram uma redução de 77% dos casos de dengue nas áreas que receberam o mosquito <i>Aedes aegypti</i> infectado com a bactéria <i>Wolbachia.</i> Trata-se da mesma técnica utilizada no Brasil pelo Método Wolbachia, iniciativa conduzida pela Fundação Oswaldo Cruz — Fiocruz. Essa bactéria induz a redução da carga viral no mosquito e, consequentemente, o número de casos de dengue na área, sendo repassada por meio do cruzamento entre os insetos. Como essa bactéria é um organismo intracelular e o vírus também precisa entrar nas células para se reproduzir, ambos necessitarão de recursos comuns.</p><p>(COSTA, G. Agência Fiocruz de Notícias. Estudo confirma eficácia do Método Wolbachia para dengue. Disponível em: https://portal.fiocruz.br. Acesso em: 3 jun. 2022. Adaptado)</p><p>Essa tecnologia utilizada no combate à dengue consiste na: competição do vírus e da bactéria no hospedeiro.</p>",
    resposta: true,
    dificuldade: "fácil"
  },
  {
